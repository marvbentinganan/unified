                ...
                <form action="{{ route('lesson.add') }}" method="POST" id="lesson-form" class="ui form">
                    ...
                    <div class="three fields">
                        <div class="field">
                            ...
                            {!! SemanticForm::select('department_id', $departments, null)->placeholder('Select Department...') !!}
                        </div>
                        <div class="field">
                            <label for="">Course / Strand</label>
                            {!! SemanticForm::select('program_id', $programs, null)->placeholder('Select Course / Strand...') !!}
                        </div>
                        <div class="field">
                            <label for="">Subject</label>
                            {!! SemanticForm::select('subject_id', $subjects, null)->placeholder('Select Subject...') !!}
                        </div>
                    </div>
                    <div class="field">
